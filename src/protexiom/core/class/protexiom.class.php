...
class protexiomCmd extends cmd {
    ...
    public function execute($_options = array()) {
    	...
    	$myError="";
    	log::add('protexiom', 'debug', '['.$protexiom->name.'-'.$protexiom->getId().'] '."Running ".$this->name." CMD", $protexiom->getName());
    	...
    	if ($this->getType() == 'info') {
        	...
        	if($myError){
    			log::add('protexiom', 'error', '['.$protexiom->name.'-'.$protexiom->getId().'] '."An error occured while running $this->name action: $myError", $protexiom->getName());
        	...
        	//unknown cmd type
      		log::add('protexiom', 'error', '['.$protexiom->name.'-'.$protexiom->getId().'] '."$this->getType(): Unknown command type for $this->name", $protexiom->getName());
